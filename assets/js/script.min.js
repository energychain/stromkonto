...
$(document).ready(function() {
    ...
    $('#btn_change').click(function() {
       ...
       let keys = Object.keys(localStorage);
       for(var i=0;i<keys.length;i++) {
           console.log(keys[i].substr(0,6));
           if(keys[i].substr(0,6)=="alias_") {               
               html+='<a role="presentation" href="#" onclick="$(\'#account\').val(\''+window.localStorage.getItem(keys[i])+'\');openAccount();" class="dropdown-item">'+keys[i].substr(6)+'</a>';
           }            
       }    
